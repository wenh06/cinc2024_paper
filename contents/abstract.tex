...
Results: Our team (``Revenger'') achieved a score of 0.33 for the classification problem on the hidden validation set, ranked 41/90; and signal-to-noise ratio (SNR) of -0.733 for the digitization problem, ranked 47/84.
